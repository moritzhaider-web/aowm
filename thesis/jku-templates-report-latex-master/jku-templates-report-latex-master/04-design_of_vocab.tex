...
\begin{verbatim}
	dct:title
		...
		dct:domainIncludes  
			...
			aowm:Distribution,
			aowm:Catalog ;
		dct:description  "dct: A name given to the resource."@en ;
...
On the other hand, the definition for creating a new property follows:
\begin{verbatim}
	aowm:supportPeriod
		a owl:DatatypeProperty
...
foaf:homepage       
	...
	dcterms:description "FOAF: A homepage for some thing."@en ;
