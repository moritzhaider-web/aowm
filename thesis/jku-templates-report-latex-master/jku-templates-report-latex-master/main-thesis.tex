% !TeX document-id = {4d6aea67-a4f3-4359-8da4-5fedcc46b812}
% !TeX program = xelatex
% !TeX encoding = UTF-8
...
%% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage[bathesis,TNF]{jkureport}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% 
...
%% 
%\usepackage{csquotes}
\usepackage[backend=biber,style=numeric,citestyle=numeric,maxbibnames=99]{biblatex}
...
% Nur Kapitel als Marke
\automark[chapter]{chapter}

% Kopfzeile
\ihead{\makebox[0pt][l]{\leftmark}} % linksbündig, ohne Einzug
\chead{}
\ohead{}
...
% Kapitelanfangsseiten ohne Kopfzeile
...
\title{Annotating Ontologies With Metadata}
...
\author{Moritz~Haider \matno{k12215632}}
...
\supervisor{\prefix{a.Univ.-Prof. DI Dr.} Wolfram~Wöß}
...
\submissiondepartment{Institute for
...
\import{./}{02-background_and_general_information}
\import{./}{03-analysis_of_doc_tools}
\import{./}{04-design_of_vocab}
